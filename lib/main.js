	...
	function renderSquare(container, square) {
		square.match({
			...
			'community-chest': function (name) {
				writeText(container, name, 16, 18);
			},
		
			'chance': function (name) {
            // Add a symbol/image to the chance square
            container.append('g')
                .attr('transform', 'scale(0.2) translate(50, 140)')
                .html(Symbols.chance_icon());
           //     .html(Symbols.questionMark()); // This will use a custom question mark symbol
                
            writeText(container, name, 16, 19);
        },			
			...
			'luxury-tax': function (name) {
				writeText(container, name, 16, 18);
				writeText(container, i18n.LUXURY_TAX_DESCRIPTION, SQUARE_HEIGHT - 18, 10);
			},
...
(function() {
	...
	function standardProperties() {
		...
		return {
			mediterranean: 	Property.estate('md', i18n.PROPERTY_MD, groups[0], {value: 600,  rent: 20}),
			baltic:			Property.estate('bt', i18n.PROPERTY_BT, groups[0], {value: 600,  rent: 40}),
			east:			Property.estate('et', i18n.PROPERTY_ET, groups[1], {value: 1000, rent: 60}),
			vermont:		Property.estate('vt', i18n.PROPERTY_VT, groups[1], {value: 1000, rent: 60}),
			connecticut:	Property.estate('cn', i18n.PROPERTY_CN, groups[1], {value: 1200, rent: 80}),
			charles:		Property.estate('cl', i18n.PROPERTY_CL, groups[2], {value: 1400, rent: 100}),
			us:				Property.estate('us', i18n.PROPERTY_US, groups[2], {value: 1400, rent: 100}),
			virginia:		Property.estate('vn', i18n.PROPERTY_VN, groups[2], {value: 1600, rent: 120}),
			jack:			Property.estate('jk', i18n.PROPERTY_JK, groups[3], {value: 1800, rent: 140}),
			tennessee:		Property.estate('tn', i18n.PROPERTY_TN, groups[3], {value: 1800, rent: 140}),
			newYork:		Property.estate('ny', i18n.PROPERTY_NY, groups[3], {value: 2000, rent: 160}),
			kentucky:		Property.estate('kt', i18n.PROPERTY_KT, groups[4], {value: 2200, rent: 180}),
			indiana:		Property.estate('in', i18n.PROPERTY_IN, groups[4], {value: 2200, rent: 180}),
			illinois:		Property.estate('il', i18n.PROPERTY_IL, groups[4], {value: 2400, rent: 200}),
			atlantic:		Property.estate('at', i18n.PROPERTY_AT, groups[5], {value: 2600, rent: 220}),
			ventnor:		Property.estate('vr', i18n.PROPERTY_VR, groups[5], {value: 2600, rent: 220}),
			marvin:			Property.estate('mv', i18n.PROPERTY_MN, groups[5], {value: 2800, rent: 240}),
			pacific:		Property.estate('pa', i18n.PROPERTY_PA, groups[6], {value: 3000, rent: 260}),
			northCarolina:	Property.estate('nc', i18n.PROPERTY_NC, groups[6], {value: 3000, rent: 260}),
			pennsylvania:	Property.estate('pn', i18n.PROPERTY_PN, groups[6], {value: 3200, rent: 280}),
			park:			Property.estate('pk', i18n.PROPERTY_PK, groups[7], {value: 3500, rent: 350}),
			broadwalk:		Property.estate('bw', i18n.PROPERTY_BW, groups[7], {value: 4000, rent: 500}),
...
(function() {
	...
	exports.CONFIGURE_GAME_TITLE = '福來大富翁-遊戲設定';
	
	// Buttons
	exports.BUTTON_NEW_GAME = '重新開始';
	exports.BUTTON_START_GAME = '開始遊戲';
	exports.BUTTON_ADD_PLAYER = '點擊此處新增玩家';
	
	// Choices
	exports.CHOICE_ROLL_DICE = '擲骰子';
	exports.CHOICE_FINISH_TURN = '完成這一回合';
	exports.CHOICE_BUY_PROPERTY = '購買 {property} : {price}';
	exports.CHOICE_PAY_RENT = '付房租 {rent} 給 {toPlayer}';
	exports.CHOICE_GO_BANKRUPT = '破產...';
	exports.CHOICE_PAY_TAX = '繳  {amount} 稅款';
	exports.CHOOSE_FLAT_TAX = '選擇統一稅率: {amount}';
	exports.CHOOSE_PERCENTAGE_TAX = '選擇 {percentage}% 稅率';
	exports.CHOICE_CALCULATE_DICE_RENT = '擲骰子並支付結果的 {multiplier} 倍的租金';
	...
	// Log messages
	exports.LOG_DICE_ROLL = '{player} 擲了一個 {die1} 另一個是 {die2}';
	exports.LOG_DOUBLE_DICE_ROLL = '{player} 擲兩顆骰子一樣: {dice}';
	exports.LOG_PROPERTY_BOUGHT = '{player} 買了 {property}';
	exports.LOG_RENT_PAID = '{fromPlayer} 付 {amount} 給 {toPlayer}';
	exports.LOG_SALARY = "{player} 通過“GO”並獲得 $5000元";
	...
	// Squares
	exports.CHANCE = '機會';
	exports.COMMUNITY_CHEST = '公益金';
	exports.INCOME_TAX = '所得稅';
	exports.LUXURY_TAX = '奢侈稅';
	exports.LUXURY_TAX_DESCRIPTION = "通過 並支付$500元";
	exports.INCOME_TAX_DESCRIPTION = "支付$2000元";
	exports.START_DESCRIPTION = "路過時領 $5000 元";
	exports.VISITING_JAIL = "只是 參觀";//Just Visiting
	exports.FREE_PARKING = "免費 停車";
	exports.GO_TO_JAIL = "入獄";//Go to jail
	
	exports.COMPANY_WATER = '台灣自來水';
	exports.COMPANY_ELECTRIC = "台灣 電力公司";
	
	exports.RAILROAD_READING = '臺北火車站';
	exports.RAILROAD_PENN = '臺中火車站';
	exports.RAILROAD_B_O = '臺南火車站';
	exports.RAILROAD_SHORT = '高雄火車站';
	
	exports.PROPERTY_MD = '東湖路';
	exports.PROPERTY_BT = '東湖路';
	exports.PROPERTY_ET = "東湖路";
	exports.PROPERTY_VT = '東湖路';
	exports.PROPERTY_CN = '東湖路';
	exports.PROPERTY_CL = '東湖路';
	exports.PROPERTY_US = '東湖路';
	exports.PROPERTY_VN = '東湖路';
	exports.PROPERTY_JK = '東湖路';
	exports.PROPERTY_TN = '東湖路';
	exports.PROPERTY_NY = '東湖路';
	exports.PROPERTY_KT = '東湖路';
	exports.PROPERTY_IN = '東湖路';
	exports.PROPERTY_IL = '東湖路';
	exports.PROPERTY_AT = '東湖路';
	exports.PROPERTY_VR = '東湖路';
	exports.PROPERTY_MN = '東湖路';
	exports.PROPERTY_PA = '東湖路';
	exports.PROPERTY_NC = '東湖路';
	exports.PROPERTY_PN = '東湖路';
	exports.PROPERTY_PK = '東湖路';
	exports.PROPERTY_BW = '東湖路';
	
	// Player name
	exports.DEFAULT_PLAYER_NAME = '玩家 {index}';
	
	// Player types
	exports.PLAYER_TYPE_HUMAN = '人';
	exports.PLAYER_TYPE_COMPUTER = '電腦';
	
	// Price formatting
	exports.PRICE_STRING = '價格 {price}';
...
(function() {
	...
	exports.render = function (container, messages) {
		...
		// Add the URL link
    var link = console.append('a')
        .classed('game-log-link', true)
        .attr('href', 'https://www.fruitlife.com.tw')
        .text('歡迎隨時訪問 福來')
...
(function() {
	...
	exports.chance_icon = function () {
		return '<circle cx="63.2109" cy="37.5391" r="18.1641" fill="black"/>+<rect width="224" height="324" rx="24" fill="#4f4"/>';	};
