...
(function() {
	...
	exports.CHOICE_TRADE = "與 {player}交易";
	...
	// Squares
	exports.CHANCE = '機會';//Chance
	exports.COMMUNITY_CHEST = '公益金';//Community Chest
	exports.INCOME_TAX = '所得稅';//Income Tax
	exports.LUXURY_TAX = '奢侈稅';//Luxury Tax
	exports.LUXURY_TAX_DESCRIPTION = "付2000元";//Pay $75
	exports.INCOME_TAX_DESCRIPTION = "付2000元";//Pay 10% or $200
	exports.START_DESCRIPTION = "通過後領取2000元工資";//Collect $200 salary as you pass
	exports.VISITING_JAIL = "Just visiting";
	exports.FREE_PARKING = "免費停車";//Free parking
	...
	exports.PROPERTY_MD = '成功路1段';//Mediterranean Avenue
	exports.PROPERTY_BT = '成功路2段';//Baltic Avenue
	exports.PROPERTY_ET = "成功路3段";//Oriental Avenue
	exports.PROPERTY_VT = '成功路4段';//Vermont Avenue
	exports.PROPERTY_CN = '成功路5段';//Connecticut Avenue
	exports.PROPERTY_CL = '成功路6段';//St.Charles Place
	exports.PROPERTY_US = '成功路7段';//States Avenue
	exports.PROPERTY_VN = '成功路8段';//Virginia Avenue
	exports.PROPERTY_JK = '成功路9段';//St.James Place
	exports.PROPERTY_TN = '成功路10段';//Tennessee Avenue
	exports.PROPERTY_NY = '成功路11段';//New York Avenue
	exports.PROPERTY_KT = '成功路12段';//Kentucky Avenue
	exports.PROPERTY_IN = '成功路13段';//Indiana Avenue
	exports.PROPERTY_IL = '成功路14段';//Illinois Avenue
	exports.PROPERTY_AT = '成功路15段';//Atlantic Avenue
	exports.PROPERTY_VR = '成功路16段';//Ventnor Avenue
	exports.PROPERTY_MN = '成功路17段';//Marvin Gardens
	exports.PROPERTY_PA = '成功路18段';//Pacific Avenue
	exports.PROPERTY_NC = '成功路19段';//North Carolina Avenue
	exports.PROPERTY_PN = '成功路20段';//Pennsylvania Avenue
	exports.PROPERTY_PK = '成功路21段';//Park Place
	exports.PROPERTY_BW = '成功路22段';//Boardwalk
